 ...
 *
 * Produced by `SqlControlAdapter.lowerToDriverStatement`. All literal values
 * that required inline substitution (e.g. DDL `DEFAULT` clauses where the
 * dialect grammar forbids parameters) have been encoded by their column's
