...
function ifDefined<K extends string, T>(
  key: K,
  value: T | undefined,
...
export class SelectAstBuilder {
  ...
  private projectValue: ReadonlyArray<ProjectionItem>;
  ...
  addProject(alias: string, expr: Expression | LiteralExpr): this {
    this.projectValue = [...this.projectValue, createProjectionItem(alias, expr)];
    return this;
  }
...
export class InsertAstBuilder {
  ...
  private valuesMap: Record<string, ColumnRef | ParamRef> = {};
  ...
  values(values: Record<string, ColumnRef | ParamRef>): this {
