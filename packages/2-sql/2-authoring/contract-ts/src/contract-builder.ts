...
type ContractDefinition<
  ...
  Types extends Record<string, StorageTypeInstance | SqlEnumType>,
...
export function defineContract<
  ...
  const Types extends Record<string, StorageTypeInstance | SqlEnumType> = Record<never, never>,
...
export function defineContract(
  ...
  factory?: ContractFactory<
    ...
    Record<string, StorageTypeInstance | SqlEnumType>,
