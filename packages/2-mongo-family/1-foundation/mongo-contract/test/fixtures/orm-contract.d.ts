...
type ContractBase = {
  ...
  readonly valueObjects: { readonly HomeAddress: { readonly fields: { readonly city: { readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' }; readonly nullable: false }; readonly country: { readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' }; readonly nullable: false } } } };
  readonly storage: { readonly namespaces: { readonly __unbound__: { readonly id: '__unbound__'; readonly kind: 'mongo-namespace'; readonly collections: { readonly tasks: MongoCollection; readonly users: MongoCollection } } }; readonly storageHash: StorageHash };
};
