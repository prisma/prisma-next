...
type ContractBase = {
  ...
  readonly storage: { readonly namespaces: { readonly __unbound__: { readonly id: '__unbound__'; readonly collections: { readonly tasks: MongoCollection; readonly users: MongoCollection } } }; readonly storageHash: StorageHash };
};
