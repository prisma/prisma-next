...
- **Adapter interface**: `MongoAdapter` — defines `lower(plan: MongoQueryPlan): AnyMongoWireCommand`, the contract for converting a typed query plan into a wire command
