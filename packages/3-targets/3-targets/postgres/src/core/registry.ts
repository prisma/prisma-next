 ...
 *
 * Public consumer surface for the postgres codec set: the postgres
 * adapter and any other consumer that needs to enumerate or look up a
 * postgres codec by id consumes this rather than the raw descriptor
 * array. See ADR 208.
 */
