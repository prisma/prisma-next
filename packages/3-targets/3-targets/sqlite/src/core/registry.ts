 ...
 *
 * Public consumer surface for the sqlite codec set: the sqlite adapter
 * and any other consumer that needs to enumerate or look up a sqlite
 * codec by id consumes this rather than the raw descriptor array.
 * See ADR 208.
 */
