    ...
    const updatedContract = makeContract(
      {
        config: makeTable({
          ...
          label: {
            ...
            codecId: 'pg/text@1',
            nullable: false,
            default: { kind: 'expression', expression: "'untitled'::text" },
          },
        }),
      },
      'set-default-updated',
    ...
    const baselineContract = makeContract(
      {
        config: makeTable({
          ...
          status: {
            ...
            codecId: 'pg/text@1',
            nullable: false,
            default: { kind: 'expression', expression: "'draft'::text" },
          },
        }),
      },
    ...
    const updatedContract = makeContract(
      {
        config: makeTable({
          ...
          status: {
            ...
            codecId: 'pg/text@1',
            nullable: false,
            default: { kind: 'expression', expression: "'active'::text" },
          },
        }),
      },
    ...
    const updatedContract = makeContract(
      {
        config: makeTable({
          ...
          label: {
            ...
            codecId: 'pg/text@1',
            nullable: false,
            default: { kind: 'expression', expression: "'unknown'::text" },
          },
        }),
      },
    ...
    const baselineContract = makeContract(
      {
        item: makeTable({
          ...
          uid: {
            ...
            codecId: 'pg/uuid@1',
            nullable: false,
            default: { kind: 'expression', expression: "'00000000-0000-0000-0000-000000000000'" },
          },
        }),
      },
      'fn-default-baseline',
    ...
    const updatedContract = makeContract(
      {
        event: makeTable({
          ...
          created_at: {
            ...
            default: {
              kind: 'expression',
              expression: "'2023-01-01 00:00:00+00'::timestamp with time zone",
            },
          },
        }),
      },
