...
// The schema's inferred output flows into the codec's TInferred slot —
// narrowed fields, optional markers, literal types all preserved.
type ProductInfer = typeof productSchema.infer;
export type _ProductJs_MatchesInfer = Assert<IsEqual<ProductJs, ProductInfer>>;

// Different schemas produce distinct TInferred — no conflation through
// the codec id.
...
// arktypeJsonCodec descriptor's typeParams shape is
