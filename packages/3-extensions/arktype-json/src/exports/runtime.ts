 ...
 * the SQL runtime's `codecs:` slot. Per TML-2357 M2 Phase A, the legacy
 * `parameterizedCodecs:` slot retired — the unified descriptor map
 * dispatches every codec id, parameterized or not.
 *
