 ...
 *
 * Public consumer surface for the arktype-json codec set. Currently a
 * single entry (`arktype/json@1`); the registry shape stays consistent
 * with the other codec-shipping packages so consumers don't need to
 * special-case extensions. See ADR 208.
 */
