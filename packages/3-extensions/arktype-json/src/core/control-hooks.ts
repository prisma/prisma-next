 ...
 * validation, not a DDL-shape parameter. The hook is therefore an
 * identity `expandNativeType`: emit `jsonb` always.
 *
 * Registered through the control-extension descriptor's
