/**
 * Client-safety test for @prisma-next/mongo/static.
 *
 * Walks the source import graph starting from src/exports/static.ts and asserts
 * that no reachable source file imports mongodb or @prisma-next/driver-mongo.
 * This is a source-level check, which is cheaper than building and inspecting
 * the bundle, and catches driver imports before they reach the build step.
 */
...
const FORBIDDEN = ['mongodb', '@prisma-next/driver-mongo'];
...
describe('@prisma-next/mongo/static client-safety', () => {
