...
export const User = extensionModel(
  'User',
  {
    ...
    fields: {
      ...
      image: field.column(pgText).optional(),
...
export const Session = extensionModel(
  'Session',
  {
    ...
    fields: {
      ...
      ipAddress: field.column(pgText).optional(),
      userAgent: field.column(pgText).optional(),
      createdAt: field.column(pgTimestamptz),
      updatedAt: field.column(pgTimestamptz),
    },
    table: 'session',
...
export const Account = extensionModel(
  'Account',
  {
    ...
    fields: {
      ...
      accessToken: field.column(pgText).optional(),
      refreshToken: field.column(pgText).optional(),
      idToken: field.column(pgText).optional(),
      accessTokenExpiresAt: field.column(pgTimestamptz).optional(),
      refreshTokenExpiresAt: field.column(pgTimestamptz).optional(),
      scope: field.column(pgText).optional(),
      password: field.column(pgText).optional(),
      createdAt: field.column(pgTimestamptz),
      updatedAt: field.column(pgTimestamptz),
    },
    table: 'account',
