    ...
    'greenfield-setup': {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Verify marker hash matches contract',
          dbState: 'initialized, marker matches contract',
          sleepAfterEnter: '10s',
        },
        {
          ordinal: '06',
          slug: 'db-schema-verify',
          command: 'prisma-next db schema-verify',
          description: 'Verify schema satisfies contract (tolerant)',
          dbState: 'initialized, schema matches contract',
          sleepAfterEnter: '10s',
        },
        {
          ordinal: '07',
          slug: 'db-schema-verify-strict',
          command: 'prisma-next db schema-verify --strict',
          description: 'Verify schema satisfies contract (strict, no extras)',
        ...
        },
        {
          ...
          description: 'Verify marker (JSON output for CI/agents)',
          dbState: 'initialized, marker matches contract',
          sleepAfterEnter: '10s',
        },
        {
          ordinal: '10',
          slug: 'db-schema-verify-json',
          command: 'prisma-next db schema-verify --json',
          description: 'Schema verification (JSON output for CI/agents)',
          dbState: 'initialized, schema matches contract',
          sleepAfterEnter: '10s',
        },
        {
    ...
    'drift-missing-marker': {
      ...
      steps: [
        ...
        },
        {
          ...
          command: 'prisma-next db schema-verify',
          description: 'Schema verify fails — no tables exist',
