 ...
 * through; that integration ships in a follow-on round (sub-spec Open
 * Question 3). In the meantime the placeholder documents the intent and
 * keeps the file present so consumers can still resolve the path.
 */
