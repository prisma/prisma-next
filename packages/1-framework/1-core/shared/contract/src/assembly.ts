...
export interface AssembledComponentState {
...
export interface AssembleComponentsInput {
...
export function assembleComponents(input: AssembleComponentsInput): AssembledComponentState {
