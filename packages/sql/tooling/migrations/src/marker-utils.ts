/**
 * Contract marker SQL utilities for migration execution.
 *
 * These utilities generate SQL statements for managing the contract marker table.
 * Duplicated from @prisma-next/sql-runtime to avoid plane boundary violations
 * (migration plane cannot import from runtime plane).
 *
 * TODO: Move these to a shared plane package in the future.
 */
