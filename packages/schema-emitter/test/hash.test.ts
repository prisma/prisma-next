...
describe('Hash Stability', () => {
  it('produces same hash for identical input', async () => {
    const input = '{"target":"postgres","tables":{"user":{"columns":{"id":{"type":"int4","nullable":false,"pk":true}}}}}';
  ...
  it('produces different hashes for different inputs', async () => {
    const input1 = '{"target":"postgres","tables":{"user":{"columns":{"id":{"type":"int4","nullable":false,"pk":true}}}}}';
    const input2 = '{"target":"postgres","tables":{"user":{"columns":{"id":{"type":"int4","nullable":false,"pk":true},"email":{"type":"text","nullable":false}}}}}';
