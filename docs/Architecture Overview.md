...
- [Prisma Schema Interop](architecture%20docs/subsystems/10.%20Prisma%20Schema%20Interop.md) — `.prisma` source ingestion plus Prisma-compatible push/pull workflows
