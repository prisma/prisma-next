...
| **April workstream** | Adapter, driver, and runtime hardening; Vector Search extension pack; change stream support; introspection; typed aggregation pipeline builder |
