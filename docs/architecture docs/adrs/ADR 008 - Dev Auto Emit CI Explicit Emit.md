...
Alternatives considered
	•	Always explicit emit
	•	consistent but slows inner loop and regresses DX
	•	Always auto-emit, including CI
	•	hides determinism issues and weakens auditability
	•	Ship a long-running emitter daemon
	•	adds operational complexity with little benefit over build-tool plugins
