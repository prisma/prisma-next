...
flowchart LR
  ...
  TSQL --> PLAN
  KYS --> PLAN
  PLAN["Plan{ sql, params, ast?, meta{ storageHash, profileHash?, lane, refs, projection, annotations? } }"]
  PLAN --> RT[Runtime
...
- [ADR 160 — Kysely lane emits PN SQL AST](../adrs/ADR%20160%20-%20Kysely%20lane%20emits%20PN%20SQL%20AST.md)
...
- **ADR 160** — Kysely lane emits PN SQL AST
