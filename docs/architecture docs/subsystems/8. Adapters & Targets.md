# 8. Adapters & Targets (Extensibility)

This document defines how Prisma Next supports multiple database targets through a stable Adapter SPI, capability flags, and a conformance suite. It also outlines the "Mongo family" plan, showing how a non-SQL target plugs into the same contract-first architecture and unified Plan model.
