...
| Capability intersection across layer frontiers | [`capability-intersection.md`](./capability-intersection.md) | A lower layer's type needs an optional method whose parameter types live in a higher layer, and type erasure or casts are the tempting escapes. | Stable |
