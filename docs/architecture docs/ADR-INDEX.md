...
| 162 | ORM WhereArg literal normalization | Records Phase 2 decision to validate bound ToWhereExpr payloads then normalize ParamRef values into literals at ORM boundaries | [ADR 162 - ORM WhereArg literal normalization.md](adrs/ADR%20162%20-%20ORM%20WhereArg%20literal%20normalization.md) |
