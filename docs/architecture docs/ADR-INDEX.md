...
| 163 | ORM WhereArg literal normalization in phase 2 | Records Phase 2 decision to validate bound ToWhereExpr payloads then normalize ParamRef values into literals at ORM boundaries | [ADR 162 - ORM WhereArg literal normalization in phase 2.md](adrs/ADR%20162%20-%20ORM%20WhereArg%20literal%20normalization%20in%20phase%202.md) |
