...
- `workspace-package-not-found-run-pnpm-install.mdc` — A missing `@prisma-next/*` module (esp. post-merge/rebase) means a stale workspace; run `pnpm install`, don't chase it as a code bug
