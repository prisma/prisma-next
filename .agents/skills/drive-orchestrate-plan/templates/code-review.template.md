...
|--------|---------------------|-------|---------------------------------|----------|
| AC-B1  | <fill from spec>    | <n>   | NOT VERIFIED — round 1 pending  | —        |
| AC-B2  | <fill from spec>    | <n>   | NOT VERIFIED — round 1 pending  | —        |
...
- **Implementer:** `<id>` — first spawned in `<phase-id>` R1.
- **Reviewer:** `<id>` — first spawned in `<phase-id>` R1.
