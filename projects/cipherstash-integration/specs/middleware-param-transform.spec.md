...
CipherStash bulk-encrypt is the **first concrete consumer** ([TML-2360](https://linear.app/prisma-company/issue/TML-2360)), not the owner.
...
- [ADR 207 — Codec call context: per-query `AbortSignal` and column metadata](../../docs/architecture%20docs/adrs/ADR%20207%20-%20Codec%20call%20context%20per-query%20AbortSignal%20and%20column%20metadata.md). The codec-side context this seam complements; the `signal` plumbed by this project is the same reference.
...
- [TML-2360](https://linear.app/prisma-company/issue/TML-2360) — first concrete consumer; `projects/cipherstash-extension/spec.md`.
