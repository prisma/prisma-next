...
> **⚠️ Superseded (2026-06).** This documents the **function-based** SPI cut (PR #718, now draft) — descriptors carrying imperative `parser`/`printer` functions, built across D1–D4 + R5–R8. The project pivoted to a **declarative** descriptor + generic interpreter; see the reshaped `../../spec.md` and `../../plan.md`. The mechanism here is cherry-picked into the declarative Slice 1 (TML-2804), which will get its own dispatch plan; this file is kept as the record of the superseded approach.
