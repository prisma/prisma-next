...
- **Current verdict:** SATISFIED (R4 — app-space `@contract` gate extended to `migration graph`/`migration status`, commit `018f97184`; R3 F2 accepted-closed by orchestrator; see § Orchestrator notes)
