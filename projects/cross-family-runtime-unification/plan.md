...
- [ ] **C.3** Update related docs. `docs/Architecture Overview.md` if it references the framework `ExecutionPlan`. ADR 011 references if appropriate. Package READMEs that mention the relocated types.
