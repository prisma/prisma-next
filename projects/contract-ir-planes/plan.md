...
**Scope.** ~31 files total across the three dispatches (~18 from D1+D2 as shipped; D3 adds ~13 cleanup files, some of which retire surface introduced in D2). No on-disk contract changes.
