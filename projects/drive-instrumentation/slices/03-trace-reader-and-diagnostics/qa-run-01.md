...
| **C6** directory boundary (merge-base) | PASS | empty out-of-scope diff; slice confined to `scripts/drive-diagnostics/**`, `package.json`, `projects/drive-instrumentation/**`, `drive/retro/findings.md`. |
