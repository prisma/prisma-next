...
> - npm → the `@prisma-next/*` packages are deprecated; Prisma ORM v8 ships as [`prisma-next`](https://www.npmjs.com/package/prisma-next) (v8+), published from the new repository
> - Get started → `npm create prisma@next`
