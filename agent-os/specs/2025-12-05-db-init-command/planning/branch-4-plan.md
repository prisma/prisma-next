...
### Commit 6 — Update Postgres runner to use introspect + pure verifier

- Update Postgres runner to use `family.introspect(...)` + `verifySqlSchema(...)` for its postcondition check (no behavior change expected).
