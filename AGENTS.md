...
- **Skills — validation:** `pnpm lint:skills` checks that every `skills-contrib/*/SKILL.md` frontmatter parses (YAML-safe descriptions) and that descriptions stay within the 1024-character agentskills limit. CI runs this in the Lint job; lint-staged runs it on staged skill edits.
