...
export const authoringFixtureDir = join(__dirname, '../fixtures/authoring');
export const authoringParityFixtureDir = join(authoringFixtureDir, 'parity');
export const authoringDiagnosticsFixtureDir = join(authoringFixtureDir, 'diagnostics');
