...
import type { Contract } from '../../_fixtures/optimistic-concurrency-control/generated/contract';
import contractJson from '../../_fixtures/optimistic-concurrency-control/generated/contract.json' with {
  type: 'json',
};
