...
import type { Contract } from '../../_fixtures/handle-int-overflow/generated/contract';
import contractJson from '../../_fixtures/handle-int-overflow/generated/contract.json' with {
  type: 'json',
};
