...
const projectMetadataSchema = arktype({
  tags: 'string[]',
  repo: {
...
export const contract = defineContract<CodecTypes>()
  ...
  .table('account', (t) =>
    t
      ...
      .column('profile', { type: jsonb(profileSchema), nullable: true })
      .column('createdAt', {
  ...
  .table('project', (t) =>
    t
      ...
      .column('slug', { type: varcharColumn(128), nullable: true })
      .column('visibility', { type: projectVisibilityColumn, nullable: false })
      .column('metadata', { type: jsonb(projectMetadataSchema), nullable: true })
      .column('createdAt', {
        type: timestamptzColumn,
        default: { kind: 'function', expression: 'now()' },
      })
