...
single `audit_event` table to applications that include this package in
their `extensionPacks`.
...
[ADR 212](../../../../docs/architecture%20docs/adrs/ADR%20212%20-%20Contract%20spaces.md)).
