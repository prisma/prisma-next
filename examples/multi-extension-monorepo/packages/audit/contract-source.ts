 ...
 *
 * Authored against the on-disk-in-package convention for extension contract spaces
 * (TML-2397). The same emit
 ...
 *
 * Mirrors the cipherstash / pgvector package layout but lives at the
