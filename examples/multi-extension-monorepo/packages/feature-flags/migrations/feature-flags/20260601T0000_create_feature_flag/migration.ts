 ...
 *
 * Hand-edited (Path A — see `docs/architecture docs/adrs/
...
import { FEATURE_FLAG_TABLE, FEATURE_FLAGS_BASELINE_INVARIANT_ID } from '../../../constants';

export default class M extends Migration {
  override describe() {
    return {
      from: null,
      to: 'sha256:107ce92788984cad3aff9ee860e328048f14e156869ae418ba9ec96f31d6f4df',
    };
  }
