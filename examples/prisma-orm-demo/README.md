...
Minimal Prisma ORM example app with simple read and write queries. This app demonstrates both Prisma 7 and Prisma Next compatibility layer side-by-side.
...
This demo is set up to easily switch between using Prisma 7 and the Prisma Next compatibility layer using an environment variable.

### Using Prisma 7 (Default)
...
- If `USE_COMPAT` is not set or `false` - Uses Prisma 7 via `@prisma/client`
